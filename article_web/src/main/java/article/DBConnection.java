...
//DBConnection 클래스
//자바와 MySQL 데이터 베이스를 연결 해주는 통로 역할 
//DB 접속 정보(주소, 아이디, 비밀번호)를 한 곳에 모아두고
//어디서든 grtConnection()을 호출해서 연결을 가져다 쓸 수 있다
...
//	데이터베이스 위치(내 컴퓨터(localhost)의 3306번 포트, jdbc_db라는 이름의 db)
	private static final String URL = "jdbc:mysql://localhost:3306/jdbc_article";
//	접속 아이디
...
//		자동 import 단축키 : ctrl + shift + o
		...
		try {
//			[1단계] 드라이버 로딩 : "MySQL 드라이버, 일할 준비 되었니??" 라고 확인하는과정
